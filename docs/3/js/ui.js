...
//            col: 1,
    ...
    make(data) { return van.tags.ol({tabindex:0, style:()=>`padding:0;margin:0;box-sizing:border-box;height:${this._item.height*this._state.row}px;overflow-y:auto;`}, this.#makeLis(data)) }
    #makeLis(data) { return [...Array(this._num.row)].map((_,i)=>this._item.make(data[i], i)) }
        /*
